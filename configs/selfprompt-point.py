...
from src.models.SelfPromptPoint import SelfPointPromptSAM, PointGenModuleWithViT, PointGenModulev3
...
class Config:
    def __init__(self):
        ...
        point_gen = PointGenModuleWithViT()
        # point_gen = PointGenModulev3()
